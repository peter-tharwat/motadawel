...
--}}
<div class="col-12 px-0 py-5" style="background: #f7f7f7">
    <div class="container py-5 mt-3">
        <h2 style="color: #232323">إسم الصفحة</h2>
        <h4 style="color: #333" class="mt-3">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى</h4>
    </div>
</div>
