...
<div class="col-12 px-0 py-0">
    <div class="col-12 px-0 py-2 container" >
        <div class="col-12 px-0 d-flex row py-5 justify-content-center">
              
              <div class="col-12 col-lg-3">
                  <a href="{{route('courses')}}?type=RECORDED" style="color: #333">
                    ...
                    ">
                          <div class="col-12 px-0 py-3">
                              <h4 style="line-height: 1.5;" class="font-2">الدورات المسجلة</h4>
                              <h5 style="line-height: 1.5;font-size: 14px;color: #999">يوفر لك موقعنا العديد من الدورات التدريبية التي تعزز من مهاراتك</h5>
                          </div>
                      </div>
                      </a>
              </div>
              <div class="col-12 col-lg-3">
                  <a href="{{route('courses')}}?type=LIVE" style="color: #333">
                      <div class="col-12 p-2 course my-3" style="border:2px solid #fff;border-radius: 3px;overflow: hidden;background: #fff">
                          <img src="/images/lectures.jpg" style="
                    border-radius: inherit!important;
                    width: 100%;
                    ...
                    ">
                          <div class="col-12 px-0 py-3">
                              <h4 style="line-height: 1.5;" class="font-2">Live Trading</h4>
                              <h5 style="line-height: 1.5;font-size: 14px;color: #999">يوفر لك موقعنا العديد من الدورات التدريبية التي تعزز من مهاراتك</h5>
                          </div>
                      </div>
                      </a>
              ...
              <div class="col-12 col-lg-3">
                  <a href="{{route('courses')}}?type=OFFLINE" style="color: #333">
                      <div class="col-12 p-2 course my-3" style="border:2px solid #fff;border-radius: 3px;overflow: hidden;background: #fff">
                          <img src="/images/lectures.jpg" style="
                    border-radius: inherit!important;
                    width: 100%;
                    ...
                    ">
                          <div class="col-12 px-0 py-3">
                              <h4 style="line-height: 1.5;" class="font-2">الدورات الحضورية</h4>
                              <h5 style="line-height: 1.5;font-size: 14px;color: #999">يوفر لك موقعنا العديد من الدورات التدريبية التي تعزز من مهاراتك</h5>
                          </div>
                      </div>
                      </a>
