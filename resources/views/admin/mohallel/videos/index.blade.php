	 ...
	 <div class="col-12 px-2 pt-4 " style="background: #fff;min-height: 80vh">
	 	<div class="col-12 py-4 justify-content-between row d-flex">
	 		...
	 		<div class="col-12 col-lg-4 px-2 justify-content-end d-flex mb-2">
	 			<a href="{{route('mohallel-videos.create')}}">
	 	...
	 	<table class="table">
		  ...
		  <tbody>
		    ...
		    <tr>
		      ...
		      <td class=" row d-flex">
		      	<form method="POST" action="{{route('mohallel-videos.destroy',$video)}}" id="video_delete_{{$video->id}}">@csrf @method('DELETE')</form>
		      	<a href="{{route('mohallel-videos.edit',$video)}}" style="width: 30px;height: 30px;color: #fff;background: #2381c6;border-radius: 2px" class="d-flex align-items-center justify-content-center mx-1">
