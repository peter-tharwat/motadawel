...
<div class="col-12 py-0 px-3 row">
	 <div class="col-12  pt-4" style="background: #fff;min-height: 80vh">
	 	...
	 	<div class="col-12 col-lg-9 px-3 py-5">
	 		<form class="col-12" method="POST" action="{{route('mohallel-videos.store')}}">
	 			@csrf 
	 		...
	 		<div class="col-12 col-md-6 px-0 d-flex mb-3">
	 			...
	 			<div class="col-9 px-2" >
	 				<textarea class="form-control" name="description"  max="1000" style="min-height: 200px"  >{{old('description')}}</textarea> 
	 			</div> 
	 		</div>
	 		<div class="col-12 col-md-6 px-0 d-flex mb-3">
	 			<div class="col-3 px-2 text-start pt-1">
