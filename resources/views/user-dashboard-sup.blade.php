                     ...
                     <div class="notification-item">
                        <a href="user-dashboard.html" class="dropdown-item">
                           <div class="d-flex align-items-center">
                              <div class="avatar avatar-sm flex-shrink-0 ml-2"><img src="assets/img/team8.jpg" alt="team-img"></div>
                           ...
                           <a href="index.html" class="list-group-item list-group-item-action">
                              <div class="msg-body">
                                 <div class="msg-content">
                                    ...
                                    <h3 class="title"><i class="bx bx-log-out-circle ml-2"></i>تسجيل خروج</h3>
                                 </div>
                              </div>
                              <!-- end msg-body -->
                           </a>
         ...
         <div class="sidebar-nav-body">
            ...
            <div class="author-content">
               <div class="d-flex align-items-center">
                  <div class="author-img avatar-sm">
                     <img src="assets/img/team9.jpg" alt="testimonial image">
                  </div>
                  <div class="author-bio">
                     <h4 class="author__title">علي أحمد </h4>
            ...
            <div class="sidebar-menu-wrap">
               <ul class="sidebar-menu toggle-menu list-items">
                  <li ><a href="user-dashboard.html"><i class='bx bx-stopwatch ml-2'></i>لوحة التحكم</a></li>
                  <li><a href="user-dashboard-course.html"><i class="bx bx-book ml-2 text-color"></i>دوراتي</a></li>
				  <li class="page-active"><a href="user-dashboard-sup.html"><i class="bx bx-cart ml-2 text-color"></i>اشتراكاتي</a></li>
                 <li><a href="user-invoice.html"><i class="bx bx-list-check ml-2 text-color"></i>فواتيري</a></li>
                  <li><a href="user-dashboard-settings.html"><i class='bx bx-cog ml-2'></i>الإعدادات</a></li>
                  <li><a href="index.html"><i class='bx bx-log-out-circle ml-2' ></i>تسجيل خروج</a></li>
               </ul>
            </div>
                            ...
                            <div class="form-title-wrap">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <p class="font-size-14">عرض من ا-3 من 20 نتيجة</p>
                                    </div>
                               ...
                               <div class="table-form table-responsive">
                                   <table class="table">
                                       ...
                                       <tr>
                                           ...
                                           <th scope="col">مدة الاشتراك</th>
                                           <th scope="col">دورات العرض والطللب</th>
                                           <th scope="col">اجتماع شهري</th>
                                           <th scope="col">خصائص أخرى</th>
                                           
                                       </tr>
                                       </thead>
                                       <tbody>
                                       <tr>
                                           <th scope="row">الباقة الماسية</th>
                                           <td>
                                               <div class="table-content">
                                                   <h3 class="title">2500 RAS</h3>
                                               </div>
                                           </td>
                                           <td>سنة</td>
                                           <td>مجانا</td>
                                           <td>مجانا</td>
                                           <td>تحديات عرض وطلب. <br>
										   النظرة الفنية لجميع الأسواق.</td>
                                       </tr>
                                       <tr>
                                           <th scope="row">الباقة الماسية</th>
                                           <td>
