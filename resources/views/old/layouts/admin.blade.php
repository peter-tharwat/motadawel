        ...
        <div style="width: 280px;background: #11233b;height: 100vh;position: fixed;z-index: 1;overflow: auto" class="aside active">
            ...
            <div class="col-12 px-0">
                <div class="col-12 px-0">
                    ...
                    <a href="{{route('users.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                    ...
                    <a href="{{route('lectures.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                    ...
                    <a href="{{route('partners.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
                    ...
                    <a href="{{route('courses.index')}}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex " >
                            <div style="width: 50px" class="px-3 text-center">
