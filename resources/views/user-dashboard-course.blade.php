         ...
         <div class="sidebar-nav-body">
            ...
            <div class="sidebar-menu-wrap">
               <ul class="sidebar-menu toggle-menu list-items">
                  ...
                  <li class="page-active"><a href="user-dashboard-course.html"><i class="bx bx-book ml-2 text-color"></i>دوراتي</a></li>
				  <li><a href="user-dashboard-sup.html"><i class="bx bx-cart ml-2 text-color"></i>اشتراكاتي</a></li>
                        ...
                        <div class="form-box">
                            ...
                            <div class="form-content pb-2">
                                <div class="card-item card-item-list card-item--list">
                                    <div class="card-img">
                                        <img src="assets/img/blog.jpg" alt="hotel-img">
                                    </div>
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <h3 class="card-title">دورة تدربية مدفوعة</h3>
                                            <span class="badge badge-warning text-white ml-2">تم التسجيل</span>
                                        </div>
                                       <ul class="list-items list-items-2 pt-2 pb-3">
                                           <li><span>تاريخ البدء:</span>20 مارس 2021</li>
                                           <li><span>تاريخ الانتهاء:</span>20 أبريل 2021</li>
